...
<p>TwoFactor adds two-factor authentication (2FA) security to your CMS Made Simple installation. It requires users to verify their identity using a second factor after entering their username and password.</p>
...
<p>Unlock enterprise-grade security features:</p>
<ul>
